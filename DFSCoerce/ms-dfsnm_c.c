...
/* Standard interface: netdfs, ver. 3.0,
 ...
 extern const MIDL_STUBLESS_PROXY_INFO netdfs_ProxyInfo;
    ...
    /* [in] */ handle_t IDL_handle)
{
    ...
    _RetVal = NdrClientCall3(
                  ( PMIDL_STUBLESS_PROXY_INFO  )&netdfs_ProxyInfo,
                  0,
                  0,
                  IDL_handle);
...
static const MIDL_STUB_DESC netdfs_StubDesc = 
    ...
    0x2000001, /* MIDL flag */
    0, /* cs routines */
    (void *)& netdfs_ProxyInfo,   /* proxy/server info */
    0
    };
#ifdef __cplusplus
}
...
static const MIDL_STUBLESS_PROXY_INFO netdfs_ProxyInfo =
    {
    &netdfs_StubDesc,
    ms2Ddfsnm__MIDL_ProcFormatString.Format,
    netdfs_FormatStringOffsetTable,
